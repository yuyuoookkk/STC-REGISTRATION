        ...
        <Card className="text-center glass-card border-white/30">
          <CardContent className="pt-6 sm:pt-8 pb-6 sm:pb-8 px-4 sm:px-6">
            ...
            <p className="text-white/80 mb-4 sm:mb-6 text-sm sm:text-base">
              Terima kasih telah mendaftar untuk STC. Anda akan menerima email
              konfirmasi segera dengan detail lebih lanjut.
            </p>
            <Badge
              variant="secondary"
              className="text-xs sm:text-sm glass bg-white/20 text-white border-white/30"
            >
              ID Pendaftaran: #STC
    ...
    <div className="max-w-4xl mx-auto px-4">
      <div className="text-center mb-6 sm:mb-8">
        <div className="flex items-center justify-center gap-2 mb-3 sm:mb-4">
          ...
          <h1 className="text-xl sm:text-2xl md:text-3xl font-bold text-balance text-white">
            Pendaftaran STC
          </h1>
        </div>
        <p className="text-white/80 text-sm sm:text-base md:text-lg px-2">
          Bergabunglah dengan Stibajra Technology Competition. Daftar sekarang
      ...
      <Card className="glass-card border-white/30">
        <CardHeader className="pb-4 sm:pb-6">
          ...
          <CardDescription className="text-white/80 text-xs sm:text-sm md:text-base">
            {currentStep === 1 &&
              "Silakan berikan informasi pribadi dasar Anda"}
            {currentStep === 2 &&
              "Pilih kategori kompetisi dan tingkat pengalaman Anda"}
          ...
          {currentStep === 3 && (
            <div className="space-y-4 sm:space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                <div>
                  <h3 className="font-semibold mb-2 sm:mb-3 text-white text-sm sm:text-base">
                    Informasi Pribadi
                  </h3>
                  <div className="space-y-1 sm:space-y-2 text-xs sm:text-sm">
                    ...
                    <p className="text-white">
                      <span className="text-white/70">Tanggal Lahir:</span>{" "}
                      {formData.dateOfBirth}
                    </p>
                    <p className="text-white">
                      <span className="text-white/70">Jenis Kelamin:</span>{" "}
                      {formData.gender}
                    </p>
                  </div>
                </div>
                <div>
                  ...
                  <div className="space-y-1 sm:space-y-2 text-xs sm:text-sm">
                    ...
                    <p className="text-white">
                      <span className="text-white/70">Pengalaman:</span>{" "}
                      {formData.experience}
                    </p>
                  </div>
                </div>
