...
import { CheckCircle, User, Trophy, Upload, FileText } from "lucide-react"
    ...
    <div className="max-w-4xl mx-auto px-4">
      <div className="text-center mb-6 sm:mb-8">
        <div className="flex items-center justify-center gap-2 mb-3 sm:mb-4">
          ...
          <h1 className="text-xl sm:text-2xl md:text-3xl font-bold text-balance text-white">Pendaftaran Kompetisi</h1>
        </div>
              ...
              <div className="space-y-2">
                ...
                <Select value={formData.category} onValueChange={(value) => handleInputChange("category", value)}>
                  ...
                  <SelectContent className="glass-card border-white/30">
                    ...
                    <SelectItem value="design-maskot">Design Maskot</SelectItem>
                    <SelectItem value="digital-art">Digital Art</SelectItem>
                    <SelectItem value="design-poster">Design Poster</SelectItem>
                  </SelectContent>
                </Select>
              </div>
              <div className="space-y-2">
